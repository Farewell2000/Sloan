...
#endif
    {
        ...
        private void changeBondParametersUI(GameObject windowInstance, int id)
        {
            ...
            if (!LoginData.isServer)
            {
                ...
                string toolTipText = getBondToolTipText(bt.eqDist, dist.getDistanceInAngstrom(), bt.order);
                toolTipInstance.GetComponent<DynamicToolTip>().ToolTipText = toolTipText;
#else
                return;
#endif
        ...
        public void changeBondParameters(ForceField.BondTerm bond, int id)
        {
            ...
            // Update the visual bond object if it exists
            var atom1 = atomList[bond.Atom1];
            var atom2 = atomList[bond.Atom2];
            var visualBond = atom1.getBond(atom2);
            if (visualBond != null)
            {
                visualBond.updateBondOrder(bond.order);
            }
        ...
        private string getBondToolTipText(double eqDist, double curDist, double order)
        {
